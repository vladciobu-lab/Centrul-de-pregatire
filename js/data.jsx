...
const TEAM = [
  { id: 'andrei', name: 'Andrei P.', subject: 'Matematică', age: 28, bio: 'A făcut Politehnica, a predat la pregătire intensivă 4 ani. Are răbdare cât tot Dobrogea.' },
  { id: 'ioana', name: 'Ioana M.', subject: 'Română & Logică', age: 27, bio: 'Filologie, masterat în literatură comparată. Crede că orice text are o cheie, doar trebuie găsită.' },
  { id: 'tudor', name: 'Tudor R.', subject: 'Istorie & Geografie', age: 31, bio: 'Profesor de istorie de 6 ani. Spune că tot ce s-a întâmplat în lume e legat, și o demonstrează la fiecare ședință.' },
  { id: 'maria', name: 'Maria C.', subject: 'Biologie & Matematică (EN)', age: 26, bio: 'Medicină ani 5, predă paralel pasionată. Explică sistemul nervos cu o foaie A4 și 2 culori.' }
];

const TESTIMONIALS = [
  { id: 't1', name: 'Samira Rojin', role: 'Elevă', subject: 'Logică (BAC)', result: 'BAC: 9,15 la logică',
  ...
  { id: 't2', name: 'Sara Al Saleh', role: 'Elevă', subject: 'Istorie (BAC)',
  ...
  { id: 't3', name: 'Elena Ezariu', role: 'Elevă', subject: 'Bacalaureat',
  ...
  { id: 't4', name: 'Vlad Malureanu', role: 'Elev', subject: 'Pregătire BAC',
  ...
  { id: 't5', name: 'Vasile Iulian', role: 'Elev', subject: 'Meditații',
    quote: 'Recomand cu încredere meditațiile. Materia e predată pe înțeles și se învață foarte repede și ușor.' },
  { id: 't6', name: 'Livia Nadrag', role: 'Local Guide Google', subject: 'Meditații',
    quote: 'Nu pot spune decât cuvinte de laudă. Recomand din suflet! Super om, super profesor!' },
  { id: 't7', name: 'Thelanis', role: 'Elev', subject: 'Logică (BAC)', result: 'Toată materia în 2 luni',
    quote: 'În mai puțin de 2 luni am reușit să învăț toată materia la logică!' },
  { id: 't8', name: 'Alexia Ors', role: 'Elevă', subject: 'Logică & Română (BAC)', result: 'BAC: 9,45 la logică',
  ...
  { id: 't9', name: 'Elmas Efetekin', role: 'Părinte', subject: 'Meditații',
  ...
  { id: 't10', name: 'Delia Rusan', role: 'Elevă', subject: 'Matematică (BAC)',
  ...
  { id: 't11', name: 'A C', role: 'Elevă', subject: 'Logică (BAC)', result: 'BAC: 9,50 la logică',
  ...
  { id: 't12', name: 'Ana Maria Zanet', role: 'Elevă', subject: 'Meditații',
    quote: 'O profesoară dedicată, care explică foarte clar și face orele interesante. O recomand cu încredere! Cea mai bună este!!' },
  { id: 't13', name: 'Maria Irimia', role: 'Elevă', subject: 'Logică (BAC)', result: 'BAC: 9,90 la logică',
  ...
  { id: 't14', name: 'Loredana Vântu', role: 'Elevă', subject: 'Meditații',
  ...
  { id: 't15', name: 'Geta Deac', role: 'Elevă', subject: 'Meditații',
...
const PRICES = [
  {
    ...
    duration: '1h 45 min',
    bullets: [
      'Grupă mică de 2-3 elevi',
      'Materiale incluse, fișe, subiecte',
      'Tu alegi ritmul și frecvența'
    ],
    cta: 'Vreau să încerc'
  },
  {
    ...
    featured: true,
    bullets: [
      'Pentru cei care au nevoie de progres rapid',
      'Grupă mică de 2-3 elevi',
      'Decis împreună după ședința de cunoaștere',
      'Cu materia structurată săptămânal'
    ],
  ...
  },
  {
    ...
    badge: 'GRATUIT',
    bullets: [
      'Test inițial complet pe toată materia',
      'Acoperim teoreme, principii, moduri de rezolvare',
      'Vedem împreună unde stai și ce ai nevoie',
      'Fără obligații, fără costuri'
    ],
